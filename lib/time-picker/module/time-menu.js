...
var TimeMenu = (_temp2 = _class = function (_React$Component) {
    ...
    function TimeMenu() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this._menuRefHandler = function (ref) {
            ...
            var itemCls = (0, _classnames3.default)((_classnames = {}, _classnames[prefix + 'time-picker-menu-item'] = true, _classnames[prefix + 'disabled'] = isDisabled, _classnames[prefix + 'selected'] = index === activeIndex, _classnames));
    ...
    TimeMenu.prototype.render = function render() {
        ...
        if (last < total - 1 && value && _moment2.default.isMoment(value) && value.hour() === 23) {
